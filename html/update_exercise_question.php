...
<body>
  ...
  <form action="top.php" name="form1" method="post" enctype="multipart/form-data">
    <ul>
      <li>題名</li>
...
if ($num > 0){
?>
  <p><?=htmlspecialchars($num)?>が登録されています</p>
<?php
...
?>
      <li>問題集番号</li>
      <input type="text" name="questions" <value="<?=htmlspecialchars($q_questions)?>">
      <li>解答</li>
